...
void ADynaBomberPlayerController::OnResetVR()
{
	UHeadMountedDisplayFunctionLibrary::ResetOrientationAndPosition();
}

void ADynaBomberPlayerController::MoveToMouseCursor()
{
	if (UHeadMountedDisplayFunctionLibrary::IsHeadMountedDisplayEnabled())
	{
		if (ADynaBomberCharacter* MyPawn = Cast<ADynaBomberCharacter>(GetPawn()))
		{
...
void ADynaBomberPlayerController::MoveToTouchLocation(const ETouchIndex::Type FingerIndex, const FVector Location)
{
...
void ADynaBomberPlayerController::SetNewMoveDestination(const FVector DestLocation)
{
...
void ADynaBomberPlayerController::OnSetDestinationPressed()
{
	// set flag to keep updating destination until released
	bMoveToMouseCursor = true;
}

void ADynaBomberPlayerController::OnSetDestinationReleased()
{
